...
export const GalleryFullscreen = ({ className, isOpen }) => {
  return (
      ...
      <div className={`${className}-wrapper`}>
        <div className={`${className}-header`}>
          ...
          <div className={`${className}-header-toolbar`}>
            ...
            <button className={`${className}-header-toolbar-btn`}>
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
              ...
              >
                <g clipPath="url(#clip0_6409_53157)">
                  <rect width="11" height="11" rx="1" fill="none" />
                  <rect y="13" width="11" height="11" rx="1" fill="none" />
                  <rect x="13" width="11" height="11" rx="1" fill="none" />
                  <rect x="13" y="13" width="11" height="11" rx="1" fill="none" />
                </g>
                <defs>
            ...
            <button className={`${className}-header-toolbar-close`}>
              <svg width="24" height="24" viewBox="0 0 24 24">
                <g fill="none">
                  <g fill="#FFF">
                    <g>
