...
const CustomMetaData = ({
  ...
  if (pageType === 'article' || pageType === 'video' || pageType === 'gallery') {
    ...
    metaData['og:title'] = metaValue('og:title') || fallbackTitle
    metaData['twitter:title'] = metaValue('twitter:title') || fallbackTitle
    const sectionOgImage = metaValue('og:image') || resizedFallbackImage
        ...
        {sectionOgImage && (
          <>
            ...
            <meta
              ...
              content={metaValue('og:image:alt') || metaData['og:title']}
            />
            <meta name="twitter:image" content={sectionOgImage} />
            <meta
              name="twitter:image:alt"
              content={metaValue('twitter:image:alt') || metaData['twitter:title']}
            />
          </>
        )}
      </>
